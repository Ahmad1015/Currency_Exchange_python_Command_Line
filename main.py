...
def Currency():
    ...
    if value == 1:
        ...
        headers = ["Currency Code", "Currency Name", "Country"]
        # Define the currency data as a list of tuples
        currency_data = [
        ...
        # Create the PrettyTable instance and set the headers
        table = PrettyTable()
    ...
    try:
        ...
        for key,value in r["conversion_rates"].items():
            if key == target_Currency:
                print(f"{quantity} {first_Currency} equals to {value} {key}")
    except:
